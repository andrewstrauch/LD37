...
const SUPER_LEFT_LEFT = [
	"THIS IS THE REAL NEWS. IF YOU DON'T PRINT THIS, YOU'LL BE DOING ALL OF AMERICA A GREAT DISSERVVICE. ARE YOU SOME KIND OF NEO-NAZI? DO YOU WANT CHILDREN TO DIE?"
]
	...
	if advisor_alignment == ADVISOR_ALIGNMENT.SUPER_LEFT:
		if headline_truthiness == HEADLINE_TRUTHINESS.COMPLETELY_FALSE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = SUPER_LEFT_COMPLETELY_FALSE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = SUPER_LEFT_COMPLETELY_FALSE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = SUPER_LEFT_COMPLETELY_FALSE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = SUPER_LEFT_COMPLETELY_FALSE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.MOSTLY_FALSE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = SUPER_LEFT_MOSTLY_FALSE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = SUPER_LEFT_MOSTLY_FALSE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = SUPER_LEFT_MOSTLY_FALSE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = SUPER_LEFT_MOSTLY_FALSE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.NEUTRAL:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = SUPER_LEFT_NEUTRAL_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = SUPER_LEFT_NEUTRAL_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = SUPER_LEFT_NEUTRAL_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = SUPER_LEFT_NEUTRAL_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.MOSTLY_TRUE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = SUPER_LEFT_MOSTLY_TRUE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = SUPER_LEFT_MOSTLY_TRUE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = SUPER_LEFT_MOSTLY_TRUE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = SUPER_LEFT_MOSTLY_TRUE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.COMPLETELY_TRUE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = SUPER_LEFT_COMPLETELY_TRUE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = SUPER_LEFT_COMPLETELY_TRUE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = SUPER_LEFT_COMPLETELY_TRUE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = SUPER_LEFT_COMPLETELY_TRUE_RIGHT
	elif advisor_alignment == ADVISOR_ALIGNMENT.LEFT:
		if headline_truthiness == HEADLINE_TRUTHINESS.COMPLETELY_FALSE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = LEFT_COMPLETELY_FALSE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = LEFT_COMPLETELY_FALSE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = LEFT_COMPLETELY_FALSE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = LEFT_COMPLETELY_FALSE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.MOSTLY_FALSE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = LEFT_MOSTLY_FALSE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = LEFT_MOSTLY_FALSE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = LEFT_MOSTLY_FALSE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = LEFT_MOSTLY_FALSE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.NEUTRAL:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = LEFT_NEUTRAL_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = LEFT_NEUTRAL_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = LEFT_NEUTRAL_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = LEFT_NEUTRAL_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.MOSTLY_TRUE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = LEFT_MOSTLY_TRUE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = LEFT_MOSTLY_TRUE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = LEFT_MOSTLY_TRUE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = LEFT_MOSTLY_TRUE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.COMPLETELY_TRUE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = LEFT_COMPLETELY_TRUE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = LEFT_COMPLETELY_TRUE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = LEFT_COMPLETELY_TRUE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = LEFT_COMPLETELY_TRUE_RIGHT
	elif advisor_alignment == ADVISOR_ALIGNMENT.MODERATE:
		if headline_truthiness == HEADLINE_TRUTHINESS.COMPLETELY_FALSE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = MODERATE_COMPLETELY_FALSE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = MODERATE_COMPLETELY_FALSE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = MODERATE_COMPLETELY_FALSE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = MODERATE_COMPLETELY_FALSE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.MOSTLY_FALSE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = MODERATE_MOSTLY_FALSE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = MODERATE_MOSTLY_FALSE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = MODERATE_MOSTLY_FALSE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = MODERATE_MOSTLY_FALSE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.NEUTRAL:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = MODERATE_NEUTRAL_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = MODERATE_NEUTRAL_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = MODERATE_NEUTRAL_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = MODERATE_NEUTRAL_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.MOSTLY_TRUE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = MODERATE_MOSTLY_TRUE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = MODERATE_MOSTLY_TRUE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = MODERATE_MOSTLY_TRUE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = MODERATE_MOSTLY_TRUE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.COMPLETELY_TRUE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = MODERATE_COMPLETELY_TRUE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = MODERATE_COMPLETELY_TRUE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = MODERATE_COMPLETELY_TRUE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = MODERATE_COMPLETELY_TRUE_RIGHT
	elif advisor_alignment == ADVISOR_ALIGNMENT.RIGHT:
		if headline_truthiness == HEADLINE_TRUTHINESS.COMPLETELY_FALSE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = RIGHT_COMPLETELY_FALSE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = RIGHT_COMPLETELY_FALSE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = RIGHT_COMPLETELY_FALSE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = RIGHT_COMPLETELY_FALSE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.MOSTLY_FALSE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = RIGHT_MOSTLY_FALSE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = RIGHT_MOSTLY_FALSE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = RIGHT_MOSTLY_FALSE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = RIGHT_MOSTLY_FALSE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.NEUTRAL:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = RIGHT_NEUTRAL_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = RIGHT_NEUTRAL_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = RIGHT_NEUTRAL_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = RIGHT_NEUTRAL_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.MOSTLY_TRUE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = RIGHT_MOSTLY_TRUE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = RIGHT_MOSTLY_TRUE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = RIGHT_MOSTLY_TRUE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = RIGHT_MOSTLY_TRUE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.COMPLETELY_TRUE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = RIGHT_COMPLETELY_TRUE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = RIGHT_COMPLETELY_TRUE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = RIGHT_COMPLETELY_TRUE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = RIGHT_COMPLETELY_TRUE_RIGHT
	elif advisor_alignment == ADVISOR_ALIGNMENT.SUPER_RIGHT:
		if headline_truthiness == HEADLINE_TRUTHINESS.COMPLETELY_FALSE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = SUPER_RIGHT_COMPLETELY_FALSE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = SUPER_RIGHT_COMPLETELY_FALSE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = SUPER_RIGHT_COMPLETELY_FALSE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = SUPER_RIGHT_COMPLETELY_FALSE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.MOSTLY_FALSE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = SUPER_RIGHT_MOSTLY_FALSE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = SUPER_RIGHT_MOSTLY_FALSE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = SUPER_RIGHT_MOSTLY_FALSE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = SUPER_RIGHT_MOSTLY_FALSE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.NEUTRAL:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = SUPER_RIGHT_NEUTRAL_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = SUPER_RIGHT_NEUTRAL_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = SUPER_RIGHT_NEUTRAL_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = SUPER_RIGHT_NEUTRAL_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.MOSTLY_TRUE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = SUPER_RIGHT_MOSTLY_TRUE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = SUPER_RIGHT_MOSTLY_TRUE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = SUPER_RIGHT_MOSTLY_TRUE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = SUPER_RIGHT_MOSTLY_TRUE_RIGHT
		elif headline_truthiness == HEADLINE_TRUTHINESS.COMPLETELY_TRUE:
			if headline_alignment == HEADLINE_ALIGNMENT.SPAM:
				talking_point = SUPER_RIGHT_COMPLETELY_TRUE_SPAM
			elif headline_alignment == HEADLINE_ALIGNMENT.LEFT:
				talking_point = SUPER_RIGHT_COMPLETELY_TRUE_LEFT
			elif headline_alignment == HEADLINE_ALIGNMENT.MODERATE:
				talking_point = SUPER_RIGHT_COMPLETELY_TRUE_MODERATE
			elif headline_alignment == HEADLINE_ALIGNMENT.RIGHT:
				talking_point = SUPER_RIGHT_COMPLETELY_TRUE_RIGHT
