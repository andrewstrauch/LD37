...
func _fixed_process(delta):
	...
	_truthiness_percentage.set_text(str(_gamestate.current_truthiness) + "%")
	_left_appeal_bar.set_value(_gamestate.current_left_appeal)
	_left_appeal_percentage.set_text(str(_gamestate.current_left_appeal) + "%")
	_right_appeal_bar.set_value(_gamestate.current_right_appeal)
	_right_appeal_percentage.set_text(str(_gamestate.current_right_appeal) + "%")
	pass
